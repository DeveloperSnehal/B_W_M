...
<head>
    ...
    <!-- PAGE TITLE -->
    <title>Mind - Material Design Agency Template</title>
    <!-- BOOTSTRAP CSS -->
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="header-top-info-left">
                            <ul>
                                <li><i class="fa fa-envelope"></i> adminsupport&copy;mind.com</li>
                                <li><i class="fa fa-phone"></i>+88018964211</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                            ...
                            <div class="navbar navbar-nobg">
                                ...
                                <div class="navbar-collapse collapse">
                                    <ul class="nav navbar-nav navbar-right">
                                        ...
                                        <li><a class="smoth-scroll" href="#portfolio">work</a>
                                        </li>
    ...
    <div class="single-blogarea section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <!-- START SINGLE BLOG POST DESIGN AREA -->
                    <div class="blog-post wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.1s" data-wow-offset="0">
                        <img src="assets/images/blog/blog1.jpg" class="img-responsive" alt="">
                        <h4>Lorem ipsum dolor sit amet, consectetur</h4>
                        <h6>by admin - 08 dec 2016</h6>
                        <p>
                        ...
                        <a class="learn-more" href="single-blog.html">Read more</a>
                    </div>
                    <!-- / END SINGLE BLOG POST DESIGN AREA -->
                    <!-- START SINGLE BLOG POST DESIGN AREA -->
                    <div class="blog-post wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.3s" data-wow-offset="0">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-footer wow fadeInUp" data-wow-delay=".2s">
                        <h2>about company</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean sed elit tortor. Quisque bibendum mauris velit, sed tincidunt massa lacinia nec.</p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    <div class="footer-text wow fadeInUp" data-wow-delay=".6s">
                        <p>&copy;copyright Mind 2016 allright reserved
                            <br>Developed by wordpressboss
                        </p>
                    </div>
                </div>
            </div>
